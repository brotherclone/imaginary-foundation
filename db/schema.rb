...
ActiveRecord::Schema.define(version: 20170823154129) do
  ...
  add_index "essays", ["images_id"], name: "index_essays_on_images_id", using: :btree
  ...
  add_index "promo_cards", ["images_id"], name: "index_promo_cards_on_images_id", using: :btree
